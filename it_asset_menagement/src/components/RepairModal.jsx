      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden transform transition-all border border-slate-100">
        <div className="bg-[#1E487A] text-white px-6 py-5 flex justify-between items-center">
          ...
          <button 
            ...
            className="text-blue-200 hover:text-white transition-colors focus:outline-none bg-[#133257]/50 hover:bg-[#133257] p-1.5 rounded-xl"
          >
        ...
        <form onSubmit={handleConfirmRepair} className="p-6 md:p-8 space-y-5">
          <div className="bg-blue-50 p-5 rounded-2xl border border-blue-100 shadow-sm">
            <p className="text-xs text-[#1E487A] font-bold mb-1 uppercase tracking-wide">อุปกรณ์ที่ซ่อมเสร็จแล้ว</p>
            <p className="text-lg font-black text-[#1E487A]">{repairModal.assetName}</p>
          </div>
          ...
          {repairModal.maxRepair > 1 ? (
            <div>
              ...
              <p className="text-xs text-slate-500 mt-2 font-medium bg-slate-50 p-2 rounded-lg border border-slate-100">
                * นำกลับเข้าคลังได้สูงสุด <span className="font-bold text-[#1E487A]">{repairModal.maxRepair}</span> ชิ้น (จากรายการที่ชำรุด)
              </p>
            </div>
          ) : null}
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full border border-slate-300 p-3 rounded-xl focus:ring-2 focus:ring-[#1E487A] focus:border-[#1E487A] outline-none text-sm transition-all resize-none shadow-sm"
          ...
          <div className="flex gap-3 pt-4 border-t border-slate-100">
            ...
            <button 
              type="submit"
              className="flex-1 py-3 bg-[#1E487A] text-white rounded-xl hover:bg-[#133257] font-bold transition-all shadow-lg shadow-[#1E487A]/30 flex items-center justify-center gap-2"
            >
