...
export function printAssetDetail({
  ...
  const specSection = `
    <div style="margin-bottom:9px">
      <div style="font-size:11px;font-weight:700;color:#A65F3C;text-transform:uppercase;letter-spacing:0.08em;border-bottom:2px solid #A65F3C;padding-bottom:4px;margin-bottom:10px">ข้อมูลจำเพาะ</div>
  ...
  const purchaseSection = `
    <div style="margin-bottom:9px">
      <div style="font-size:11px;font-weight:700;color:#A65F3C;text-transform:uppercase;letter-spacing:0.08em;border-bottom:2px solid #A65F3C;padding-bottom:4px;margin-bottom:10px">การจัดซื้อ &amp; การรับประกัน</div>
      <div style="display:flex;flex-wrap:wrap;gap:14px 24px">
        ...
        ${field('ราคาจัดซื้อ', asset.cost ? `<span style="color:#A65F3C">฿${fmtTHB(asset.cost)}</span>` : '', { bold: true, large: true })}
  ...
  const ownerSection = `
    <div style="margin-bottom:9px">
      <div style="font-size:11px;font-weight:700;color:#A65F3C;text-transform:uppercase;letter-spacing:0.08em;border-bottom:2px solid #A65F3C;padding-bottom:4px;margin-bottom:10px">ผู้ครอบครอง</div>
      <div style="display:flex;flex-wrap:wrap;gap:14px 24px">
  ...
  const noteSection = asset.note ? `
    <div style="margin-bottom:9px">
      <div style="font-size:11px;font-weight:700;color:#A65F3C;text-transform:uppercase;letter-spacing:0.08em;border-bottom:2px solid #A65F3C;padding-bottom:4px;margin-bottom:10px">หมายเหตุ / รายละเอียดเพิ่มเติม</div>
  ...
  const remarkSection = asset.remark ? `
    <div style="margin-bottom:9px">
      <div style="font-size:11px;font-weight:700;color:#A65F3C;text-transform:uppercase;letter-spacing:0.08em;border-bottom:2px solid #A65F3C;padding-bottom:4px;margin-bottom:10px">Remark</div>
  ...
  const attachSection = galleryPhotos.length > 0 ? `
    <div style="margin-bottom:9px;break-inside:avoid">
      <div style="font-size:11px;font-weight:700;color:#A65F3C;text-transform:uppercase;letter-spacing:0.08em;border-bottom:2px solid #A65F3C;padding-bottom:4px;margin-bottom:10px">รูปภาพประกอบ (${galleryPhotos.length} รูป)</div>
