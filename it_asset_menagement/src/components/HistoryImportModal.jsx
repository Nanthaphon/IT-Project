    ...
    <Modal open={isOpen} onClose={onClose} size="md">
      ...
      <ModalBody className="space-y-4">
        <div className="bg-stone-50/50 border border-stone-200 rounded-xl p-4">
          <p className="text-[13px] font-medium text-clay-600 flex items-center gap-1.5 mb-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="border border-stone-200 rounded-xl p-4">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-1.5 py-2 bg-white border border-stone-200 text-stone-600 text-[13px] font-medium rounded-lg hover:bg-stone-50 hover:border-stone-300 transition-colors"
            >
              <Download className="h-4 w-4" strokeWidth={2} /> ดาวน์โหลด .csv
            </button>
          </div>
          <div className="border border-stone-200 rounded-xl p-4">
            <p className="text-xs font-medium text-stone-700 mb-2">2. อัปโหลดไฟล์ประวัติ</p>
            <label className="w-full inline-flex items-center justify-center gap-1.5 py-2 bg-clay-600 text-white text-[13px] font-medium rounded-lg hover:bg-clay-700 transition-colors cursor-pointer">
